...
const DEFAULT_PRODUCTS = [
  ...
  {
    "id": "prod-comptes-vierges",
    "name": "Comptes Vierges",
    "category": "Comptes",
    "price": 0.70,
    "oldPrice": 2.00,
    "badge": "Featured",
  ...
  {
    "id": "prod-boosts-discord",
    "name": "Boosts Serveur Discord",
    "category": "Services",
    "price": 9.90,
    "oldPrice": 18.00,
    "badge": "Featured",
  ...
  {
    "id": "prod-comptes-nitro",
    "name": "Comptes avec Nitro",
    "category": "Comptes",
    "price": 9.97,
    "oldPrice": 20.00,
    "badge": "Featured",
  ...
  {
    "id": "prod-decorations-discord",
    "name": "Décorations Discord",
    "category": "Services",
    "price": 12.92,
    "oldPrice": 22.00,
    "badge": "Featured",
...
const CATEGORIES = [
  { id: "all", name: "Tous les articles", icon: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="16.5" y1="9.4" x2="7.5" y2="4.21"/><polygon points="12 22.08 12 12 3 6.92 3 17.08 12 22.08"/><polygon points="12 22.08 21 17.08 21 6.92 12 12 12 22.08"/><polygon points="12 12 21 6.92 12 1.84 3 6.92 12 12"/></svg>`, desc: "Explorez notre inventaire complet de codes et services digitaux." },
  { id: "Gaming & Cartes", name: "Gaming & Cartes", icon: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="6" width="20" height="12" rx="3"/><path d="M6 12h4m-2-2v4m10-2h.01M15 12h.01"/></svg>`, desc: "Diamants Free Fire, UC PUBG, Robux et Riot Points VP." },
  { id: "Streaming & TV", name: "Streaming & TV", icon: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"/><line x1="7" y1="2" x2="7" y2="22"/><line x1="17" y1="2" x2="17" y2="22"/><line x1="2" y1="12" x2="22" y2="12"/><line x1="2" y1="7" x2="7" y2="7"/><line x1="2" y1="17" x2="7" y2="17"/><line x1="17" y1="17" x2="22" y2="17"/><line x1="17" y1="7" x2="22" y2="7"/></svg>`, desc: "Abonnements Netflix Premium, Shahid VIP et Spotify." },
  { id: "Recharges & Flexi", name: "Recharges & Flexi", icon: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81 7A2 2 0 0 1 22 16.92z"/></svg>`, desc: "Forfaits internet Flexi directs pour Ooredoo Tunisie." },
  { id: "Cartes Cadeaux", name: "Cartes Cadeaux", icon: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 12 20 22 4 22 4 12"/><rect x="2" y="7" width="20" height="5"/><line x1="12" y1="22" x2="12" y2="7"/><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"/><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"/></svg>`, desc: "Cartes Steam, PlayStation, Xbox, Razer et Google Play." },
  { id: "Softwares", name: "Logiciels & Softs", icon: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="2" y1="20" x2="22" y2="20"/><line x1="12" y1="17" x2="12" y2="20"/></svg>`, desc: "Licences ChatGPT Plus, VPNs, Duolingo et abonnements pro." }
];
